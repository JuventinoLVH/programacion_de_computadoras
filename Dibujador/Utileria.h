 ...
 *
 */
void DibujarArchivo(int &ancho, int &alto ,const char *direccion ,int posX=0 ,int posY=0 ,Color colFondo=NEGRO ,Color colTex=BLANCO ,bool espacios=true);
 ...
 *
 */
void DibujarArchivoAColor(int &ancho, int &alto ,const char *direccion ,int posX=0 ,int posY=0 ,Color colFondo=NEGRO ,Color colTex=BLANCO);
