...
*/
void DibujarMarco(int alto,int ancho,int posX=0, int posY=0 ,double segundos=0);
 ...
 *      a la posici&oacute;n de la esquina superior izquierda del rect&aacute;ngulo
*/
void DibujarMarcoDoble(int alto,int ancho,int posX=0, int posY=0 ,double segundos=0 ,Color colFondo=NEGRO ,Color colTex=BLANCO, bool relleno=false ,Color colRell=BLANCO);
...
void DibujarArchivo(char direccion[] ,int posX=0 ,int posY=0 ,Color colFondo=NEGRO ,Color colTex=BLANCO);
 ...
 //*************************************************************************************************************************
void AnimarArchivo(char direccion[] ,double segundos ,int posX=0 ,int posY=0 ,Color colFondo=NEGRO ,Color colTex=BLANCO);
